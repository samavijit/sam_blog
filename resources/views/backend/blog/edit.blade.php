					...
					<div class="box">
						...
						<div class="box-footer clearfix">
	                        ...
	                        <div class="pull-right">
	                        	<input type="hidden" name="published_val_at" id="published_val_at" value="">
					...
					<div class="box">
						 <div class="box-header with-border">
		                    ...
		                    <div class="box-body text-center">
								...
								<img src="{{ ($post->thumb_image_url) ? ($post->thumb_image_url):'http://placehold.it/200x150&text=No+Image' }}" alt="...">
								</div>
...
@section('script')
    <script type="text/javascript">
        ...
        $('#publish-btn').click(function(e){
        	e.preventDefault();
        	$('#published_val_at').val("published");
        	$('#post-form').submit();
        });
